...
- The S at the end stands for 'secure'. It ensures that data is encrypted between the node and the web server. It also ensures the website is legal by checking the website's certficate.

## URL

- Stands for Uniform Resource Locator. Commonly referred to as the link.
...
- Small piece of data that's stored on your computer.
...
- Cookies are majorly used for **website authentication**.

---
Did a lab on TryHackMe.
